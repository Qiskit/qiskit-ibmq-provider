...
| :---: | :---: | :---: | :---: |
| [`qiskit.providers.ibmq.experiment`](https://qiskit.org/ecosystem/ibmq-provider/apidocs/ibmq_experiment.html) | [`qiskit-ibm-experiment`](https://pypi.org/project/qiskit-ibm-experiment/)<br>([docs](https://qiskit.org/ecosystem/ibm-experiment/)) |  For the features related with the IBM Quantum experiment database service. | [guide](https://qiskit.org/ecosystem/ibm-experiment/tutorials/Migration%20Guide.html) |
| [`qiskit.providers.ibmq.runtime`](https://qiskit.org/ecosystem/ibmq-provider/apidocs/ibmq_runtime.html) | [`qiskit-ibm-runtime`](https://pypi.org/project/qiskit-ibm-runtime/)<br>([docs](https://qiskit.org/ecosystem/ibm-runtime/)) | Use this package if you prefer getting high quality probability distribution or expectation values without having to optimize the circuits or mitigate results yourself. | [guide](https://qiskit.org/ecosystem/ibm-runtime/migrate/migrate-setup.html) |
| Rest of [`qiskit.providers.ibmq`](https://qiskit.org/ecosystem/ibmq-provider/apidocs/ibmq-provider.html) | [`qiskit-ibm-provider`](https://pypi.org/project/qiskit-ibm-provider)<br>([docs](https://qiskit.org/ecosystem/ibm-provider/)) | Use this package if you need direct access to the backends to do experiments like device characterization. | [guide](https://qiskit.org/ecosystem/ibm-provider/tutorials/Migration_Guide_from_qiskit-ibmq-provider.html) |
